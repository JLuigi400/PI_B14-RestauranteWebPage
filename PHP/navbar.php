        ...
        <ul class="nav-links">
            ...
            <?php if ($is_logged): ?>
                <?php if ($id_rol == 1): // Administrador ?>
                    ...
                    <li><a href="validar_negocios.php">Validar</a></li>
                <?php elseif ($id_rol == 2): // Dueño de Restaurante ?>
                    <li><a href="gestion_platillos.php">Mi Menú</a></li>
                    <li><a href="inventario.php">Inventario</a></li>
                <?php elseif ($id_rol == 3): // Comensal ?>
                    <li><a href="buscar_restaurantes.php">Explorar</a></li>
                    <li><a href="mis_favoritos.php">Favoritos</a></li>
                <?php endif; ?>
            ...
            <?php else: ?>
                ...
                <li><a href="signup.php" class="btn-nav-signup">Crear Cuenta</a></li>
            <?php endif; ?>
        </ul>
    </div>
</nav>